                    ...
                    child: Column(
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            CircleAvatar(
                              backgroundImage: AssetImage("images/medev.jpg"),
                              radius: 30,
                            ),
                            Padding(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          IconButton(
                              ...
                              onPressed: () =>
                                  launchUrl("mailto:dochassan12@gmail.com")),
                          IconButton(
                              icon: Icon(
                              ...
                              onPressed: () => launchUrl(
                                  "https://www.linkedin.com/in/hassan-bhatti-74666a1a7/")),
                          new IconButton(
                            icon: new Icon(FontAwesomeIcons.githubSquare,
                                color: Colors.deepPurpleAccent, size: 25),
                            onPressed: () => launchUrl(
                                "https://github.com/drbhatti-develops"),
                          )
                        ],
                      ),
                    ],
